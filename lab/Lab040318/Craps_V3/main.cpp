 ...
 * Created on April 3rd, 2018, 11:34 AM
 * Purpose: Crabs
 */
...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    int w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12;//wins given value of dice
    int l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12;//lose given value of dice
    int gameLm,games,totThrw;//Number of games and total throw
